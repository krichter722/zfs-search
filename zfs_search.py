...
zfs_end_bytes = "0x"+"117a0cb17ada1002"
...
zfs_end_tail_bytes_count = 40 #16*16*4
...
def zfs_search(search_file_path, buffer_size=buffer_size_default, print_starts_ends_only=False, starts=None, ends=None, tmp_dir="/tmp", loop_device=sp.check_output([losetup, "-f"]).strip(), ):
    ...
    for start in starts:
        for end in ends:
            ...
            sp.check_call([losetup, "-d", loop_device])
